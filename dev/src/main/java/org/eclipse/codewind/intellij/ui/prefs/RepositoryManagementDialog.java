...
public class RepositoryManagementDialog extends TitleAreaDialog {
	...
	private org.eclipse.codewind.ui.internal.prefs.RepositoryManagementComposite repoComposite;
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText(CodewindUIBundle.message("RepoMgmtDialogTitle"));
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		setTitle(CodewindUIBundle.message("RepoMgmtDialogTitle"));
		setMessage(CodewindUIBundle.message("RepoMgmtDialogMessage"));
